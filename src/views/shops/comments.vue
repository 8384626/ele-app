<template>
  <div class="comments" v-if="valuetion">
    <!-- 商家评分 -->
    <section class="rating-wrap">
      <div class="rating-info">
        <h4>{{ valuetion.rating.shop_score | leaveone }}</h4>
        <div class="shop-score">
          <span>商家评分 </span>
          <rating :rating="valuetion.rating.shop_score"></rating>
        </div>
      </div>
      <div class="other-score">
        <div class="tp-score">
          <div>
            <span>味道</span>
            <p>{{ valuetion.rating.taste_score | leaveone }}</p>
          </div>
          <div>
            <span>包装</span>
            <p>{{ valuetion.rating.package_score | leaveone }}</p>
          </div>
        </div>
        <div class="rider-score">
          <span>配送</span>
          <p>{{ valuetion.rating.rider_score | leaveone }}</p>
        </div>
      </div>
    </section>
    <!-- 评论区 -->
    <div class="shop-info">
      ...
      <ul class="tags">
        <li
          v-for="(item, index) in valuetion.tags"
          :key="index"
      ...
      <ul class="comments-wrap">
        <li v-for="(item, index) in valuetion.comments" :key="index">
