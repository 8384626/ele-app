<template>
  <div class="shop" v-if="shopInfo">
    ...
    <nav class="header-nav">
      ...
      <div class="shop_image" @click="isShowInfoModel">
    ...
    <div class="index-rst">
      ...
      <info-model
        ...
        @isShowInfoModel="isShowInfoModel"
      ></info-model>
      <!-- 信息类 -->
      <div class="order">
...
<script>
import infoModel from "components/common/shop/infoModel.vue";
import activity from "components/common/shop/activity.vue";
import navBar from "components/common/shop/navBar.vue";
...
export default {
  ...
  methods: {
    ...
    isShowInfoModel() {
      this.showInfoModel = !this.showInfoModel;
    },
  },
  components: {
    infoModel,
