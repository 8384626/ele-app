<template>
  <div v-if="shopInfo" class="goods">
    ...
    <div class="menuview">
      <!-- 左侧分类列表 -->
      <scroll
        class="menuview-scroll"
        @BScrollData="menuScrollData"
        ref="mScroll"
      >
...
export default {
  ...
  methods: {
    ...
    menuScrollData(data) {
      this.menuScroll = data;
    },
    foodScrollData(data) {
      this.foodScroll = data;
    ...
    selectMenu(index) {
      ...
      this.$refs.fScroll.scrollToElement(el, 250);
    },
